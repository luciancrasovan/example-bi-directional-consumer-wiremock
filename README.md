...
[![Can I deploy Status](https://testdemo.pactflow.io/pacticipants/stan-v2-archie-client/branches/master/latest-version/can-i-deploy/to-environment/staging/badge)](https://testdemo.pactflow.io/pacticipants/stan-v2-archie-client/branches/master/latest-version/can-i-deploy/to-environment/staging/badge)
...
- `PACT_PROVIDER=stan-api-v2`: Dredd provider pacticipant on the `stan-v2` branch - (https://github.com/luciancrasovan/example-bi-directional-provider-dredd/tree/stan-v2)
