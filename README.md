...
[![Can I deploy Status](https://testdemo.pactflow.io/pacticipants/stan-v1-archie-client/branches/master/latest-version/can-i-deploy/to-environment/production/badge)](https://testdemo.pactflow.io/pacticipants/stan-v1-archie-client/branches/master/latest-version/can-i-deploy/to-environment/production/badge)
...
- `PACT_PROVIDER=stan-api-v1`: Dredd provider pacticipant on the `stan-v1` branch - (https://github.com/luciancrasovan/example-bi-directional-provider-dredd/tree/stan-v1)
...
NOTE:- It defaults to `stan-api-v1` for compatibility with the provider deployed from branch `stan-v1`.
